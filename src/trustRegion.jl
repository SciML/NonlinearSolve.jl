...
mutable struct TrustRegionCache{iip, fType, algType, uType, resType, pType,
    ...
    function TrustRegionCache{iip}(f::fType, alg::algType, u::uType, fu::resType, p::pType,
        ...
        new{iip, fType, algType, uType, resType, pType,
            INType, tolType, probType, ufType, L, jType, JC, floatType,
            trustType, suType, su2Type, tmpType}(f, alg, u, fu, p, uf, linsolve, J, jac_config, force_stop, maxiters,
            internalnorm, retcode, abstol, prob, radius_update_scheme, trust_r, max_trust_r,
            step_threshold, shrink_threshold, expand_threshold, shrink_factor,
            expand_factor, loss, loss_new, H, g, shrink_counter, step_size, u_tmp, fu_new,
...
function SciMLBase.__init(prob::NonlinearProblem{uType, iip}, alg::TrustRegion,
    ...
    return TrustRegionCache{iip}(f, alg, u, fu, p, uf, linsolve, J, jac_config,
        false, maxiters, internalnorm, ReturnCode.Default, abstol, prob,
        radius_update_scheme, initial_trust_radius,
