...
- Share bound-handling and globalization primitives across bounded algorithms, including `BoundedTrustRegion`. Preserve each method's step geometry and radius policy when consolidating helpers.
