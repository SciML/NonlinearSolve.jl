...
SCCNonlinearSolve.jl is a component of the [NonlinearSolve.jl](https://github.com/SciML/NonlinearSolve.jl) monorepo. It solves Strongly Connected Component (SCC) problems by decomposing a system into its nonlinear and linear subproblems and solving them in dependency order.
