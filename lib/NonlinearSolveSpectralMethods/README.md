...
NonlinearSolveSpectralMethods.jl is a component of the [NonlinearSolve.jl](https://github.com/SciML/NonlinearSolve.jl) monorepo. It provides Jacobian-free spectral residual methods such as DF-SANE for solving large nonlinear systems.
