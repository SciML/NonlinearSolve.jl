...
NonlinearSolveHomotopyContinuation.jl is a component of the [NonlinearSolve.jl](https://github.com/SciML/NonlinearSolve.jl) monorepo. It wraps [HomotopyContinuation.jl](https://github.com/JuliaHomotopyContinuation/HomotopyContinuation.jl) behind the SciML common interface for finding all roots (or a single root) of fully determined polynomial systems.
