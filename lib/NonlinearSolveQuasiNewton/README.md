...
NonlinearSolveQuasiNewton.jl is a component of the [NonlinearSolve.jl](https://github.com/SciML/NonlinearSolve.jl) monorepo. It provides quasi-Newton solvers (such as Broyden and Klement methods) that avoid recomputing the full Jacobian by maintaining an approximate Jacobian or its inverse.
