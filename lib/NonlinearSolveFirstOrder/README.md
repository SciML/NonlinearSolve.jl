...
NonlinearSolveFirstOrder.jl is a component of the [NonlinearSolve.jl](https://github.com/SciML/NonlinearSolve.jl) monorepo. It provides the first-order (Jacobian-based) solvers such as Newton-Raphson, Gauss-Newton, Levenberg-Marquardt, and trust-region methods for nonlinear systems and nonlinear least squares.
