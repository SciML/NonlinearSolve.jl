...
# counterpart of the ForwardDiff coverage in test/Core/bounds_sensitivity_tests.jl
# and compares against the same analytic expectations and the ForwardDiff result.
